...
import { Search, Plus, ExternalLink, LayoutList, LayoutGrid, Table, Eye, Mail, Phone } from 'lucide-react';
          ...
          {data.map((branch, index) => (
            <tr key={index} className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm">
                <div>
                  <div className="text-gray-900">Email: {branch.contactInformation.email}</div>
                  <div className="text-gray-900">Phone: {branch.contactInformation.phone}</div>
                </div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                {branch.address}
