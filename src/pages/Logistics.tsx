          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {data.map((order, index) => (
              <tr key={index} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.logisticsBuyerNPName}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.logisticsSellerNPName}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.orderCreateDateTime}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.createdBy}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.networkOrderID}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.retailOrderID}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.networkTransactionID}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.logisticsSellerNPOrderID}</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                    ${order.orderStatus === 'Completed' ? 'bg-green-100 text-green-800' : 
                      order.orderStatus === 'In Progress' ? 'bg-orange-100 text-orange-800' : 
                      'bg-gray-100 text-gray-800'}`}>
                    {order.orderStatus}
                  </span>
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.fulfillmentStatus}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.rtoStatus}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.orderUpdatedDateTime}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.readyToShip ? 'Yes' : 'No'}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.awbNo}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.readyToShipTimestamp}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.shipmentType}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.logisticsProvider}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.promisedTATDelivery}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.shippedDateTime}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.deliveredDateTime}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.pickupCity}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.deliveryCity}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.cancelledDateTime}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.cancelledBy}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.cancellationReason}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">₹{order.shippingCharges.toFixed(2)}</td>
