  ...
  const renderGridView = () => (
    <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {partnersData.map((partner) => (
        <div key={partner.id} className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          {/* Header with Actions */}
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-sm">Email: {partner.contactInformation.email}</p>
              <p className="text-sm">Phone: {partner.contactInformation.phone}</p>
            </div>
          ...
          <table className="min-w-full">
            <thead className="bg-[#F8FAFC]">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Seller Count</th>
