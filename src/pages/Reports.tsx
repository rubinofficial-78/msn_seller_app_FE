...
const headCells = [
  ...
  {
    id: "readyToShipDateTime",
    key: "readyToShipDateTime",
  ...
  {
    id: "logisticsNetworkOrderId",
    key: "logisticsNetworkOrderId",
    label: "Logistics Network Order Id",
  },
  {
    id: "logisticsNetworkTransactionId",
    key: "logisticsNetworkTransactionId",
  ...
  {
    id: "totalShippingCharges",
    key: "totalShippingCharges",
      ...
      <div className="bg-white p-4 rounded-lg border border-gray-200 space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            ...
            <select
              id="order-status-select-reports"
          ...
          <div className="flex items-end">
            <button
              id="clear-filters-button-reports"
              onClick={() => {
