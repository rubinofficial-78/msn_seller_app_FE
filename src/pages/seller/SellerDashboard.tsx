...
import {
  ...
  getCategorySalesMatrix,
  getProductSalesMatrix,
...
const SellerDashboard = () => {
  ...
  const { data: categorySalesMatrix, loading: categoryMatrixLoading } =
    useSelector((state: RootState) => state.data.categorySalesMatrix);

  const { data: productSalesMatrix, loading: productMatrixLoading } =
    useSelector((state: RootState) => state.data.productSalesMatrix);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm">
          ...
          {productMatrixLoading ? (
            ...
            <SimpleBarChart dataObject={productSalesMatrix} />
          )}
        </div>
      </div>
    </div>
...
const StatCard: React.FC<StatCardProps> = ({
  ...
  >
    <div className="flex items-center gap-3 sm:gap-4">
      <div className={`p-2 sm:p-3 rounded-lg ${bgColor}`}>{icon}</div>
      <div>
